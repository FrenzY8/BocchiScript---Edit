...
const { F, level, card, register, afk, reminder, premium } = require('../function')
const Exif = require('../tools/exif')
const exif = new Exif()
const cd = 4.32e+7
const FCount = 9999999999
...
const _F = JSON.parse(fs.readFileSync('./database/user/F.json'))
...
module.exports = msgHandler = async (bocchi = new Client(), message) => {
    try {
        ...
        body = (type === 'chat' && body.startsWith(prefix)) ? body : (((type === 'image' || type === 'video') && caption) && caption.startsWith(prefix)) ? caption : 'By : FrenzY X BOT'
        ...
        cron.schedule('0 0 * * *', () => {
            const reset = []
            fs.writeFileSync('./database/user/F.json', JSON.stringify(reset))
        }, {
            scheduled: true,
            timezone: 'Asia/Jakarta'
        })

        // F by HAFIZH base from ElainaBOT
        const isF = (userId) => {
            ...
            if (found === false) {
                const obj = { id: userId, F: 5 }
                _F.push(obj)
                fs.writeFileSync('./database/user/F.json', JSON.stringify(_F))
                return false
            }
        }
        ...
        if (chats == '!menu') {
            if (!isGroupMsg) await bocchi.reply(from, `Untuk Meenggunakan FrenzY X BOT Gunakan *#*`, id)
        ...
        */
        ...
        // F
        if (isCmd && isF(from)) return await bocchi.reply(from, 'Maaf F Kamu Tersisa : *0*\nMerasa Belum Pernah Menggunakan BOT Ini? Mungkin Kamu Belum Daftar!\nDaftar Untuk Mendapatkan F!', id)

        // Log
        if (isCmd && !isGroupMsg) {
            console.log(color('[ PRIVATE CHAT ]'), color(time, 'yellow'), color(`${command} [${args.length}]`), 'Yang Nge Chat :', color(pushname))
            await bocchi.sendSeen(from)
        }
        if (isCmd && isGroupMsg) {
            console.log(color('[ CHAT GRUP ]'), color(time, 'cyan'), color(`${command} [${args.length}]`), 'Orang Pengirim', color(pushname), 'Di Grup', color(name || formattedTitle))
            await bocchi.sendSeen(from)
        }
        ...
        switch (command) {
            case 'antiporn': // Premium, chat VideFikri
                await bocchi.reply(from, 'Premium Feature!\n\nContact: wa.me/6285283200715?text=Buy%20Anti%20Porn', id)
            break
            ...
            case 'daftar':
                ...
                console.log(color('*[ ADA YANG BARU DAFTAR ]'), color(time, 'red'), 'Namanya :', color(namaUser, 'cyan'), 'Umur Nya : ', color(umurUser, 'cyan'), 'Serial Dia', color(serialUser, 'red'))
            break
                ...
                downloader.ytdl(url)
                    .then(async (res) => {
                        if (res.status === 'error') {
                            ...
                            await bocchi.reply(from, ind.videoF(), id)
                        } else {
            ...
            case 'changelog':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                await bocchi.sendText(from, ind.ChangeLog(), id)
            break            
            case 'afk': // by Slavyan
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                if (!isGroupMsg) return await bocchi.reply(from, ind.groupOnly(), id)
            ...
            case 'kalkulator':
                ...
                if (typeof mathjs.evaluate(q) !== 'number') {
                    ...
                    await bocchi.reply(from, `*「 MATH 」*\n\n${q} = ${mathjs.evaluate(q)}\n\nTerima Kasih Sudah Menggunakan Kalkulator FrenzY X BOT\nFollow @kenajaga.exe Percuma Keren Kalo Ga Follow`, id)
                }
            break
            case 'shopee':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
            ...
            break
            case '#infonomor':
                if (!isRegistered) return await benny.reply(from, `Hi *${pushname}* Nomor Mu Blum Terdaftar Disini\nKamu Bisa Sign UP Disini!\nKetik *#daftar <nama mu>* Abaikan Tanda Pagar Kutip\n\nContoh : *#daftar kiki*\nPowered By *FrenzY X BOT*`, id)
            ...
            if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                ...
                await bocchi.sendGiphyAsSticker(from, 'https://media.giphy.com/media/S8507sBJm1598XnsgD/source.gif')
                bocchi.sendTextWithMentions(from, '@' + person + ' *Telah MenSlap ( Menampar )* ' + arg[1])
                break
            case 'tafsir':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
            ...
            case 'reminder': // by Slavyan
                ...
                const intervRemind = setInterval(async () => {
                    if (Date.now() >= reminder.getReminderTime(sender.id, _reminder)) {
                        await bocchi.sendTextWithMentions(from, `⏰ *「 REMINDER 」* ⏰\n\nAkhirnya tepat waktu~ @${sender.id.replace('@c.us', '')}\n\nReminder Ini Masih Menyimpan Data Untuk Mengingatkan Anda ${reminder.getReminderMsg(sender.id, _reminder)}\n\n➸ *Pesan Yg Anda Kirim*: ${reminder.getReminderMsg(sender.id, _reminder)}`)
            ...
            case 'help':
                ...
                const reqXpMenu = 5000 * (Math.pow(2, levelMenu) - 1)
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                if (args[0] === '1') {
                    await bocchi.sendFile(from, './fotonya/disini/promosi.jpg', 'promosi.jpg',  await bocchi.sendText(from, ind.menuDownloader()), id)
                } else if (args[0] === '2') {
            ...
            case 'join':
                ...
                if (isOwner) {
                    ...
                    if (getGroupData.length >= groupF) {
                        await bocchi.reply(from, `Invite refused. Max group is: ${groupF}`, id)
                    } else if (getGroupData.size <= memberF) {
                        await bocchi.reply(from, `Invite refused. Minimum member is: ${memberF}`, id)
                    } else {
                        await bocchi.joinGroupViaLink(url)
                        await bocchi.reply(from, ind.ok(), id)
                        await bocchi.sendText(checkInvite.id, `Hello!! I was invited by ${pushname}`)
            ...
            break
            case 'F':
                if (isPremium || isOwner) return await bocchi.reply(from, '⤞ F left: ∞ (UNFED)', id)
                await bocchi.reply(from, `⤞ F left: ${FCount - getF(sender.id)} / 25\n\n*_F direset pada pukul 00:00 WIB_*`, id)
            break
            ...
            case 'asupan': // shansekai
                ...
                fun.asupan()
                    .then(async (body) => {
                        ...
                        await bocchi.sendFileFromUrl(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, 'asupan.mp4', 'Asupan Ni....\nFollow *@kenajaga.exe* yak:)\n\nAsupan Code By : Bocchi', id)
            ...
            case 'phmaker':
                ...
                await bocchi.sendFileFromUrl(from, `https://docs-jojo.herokuapp.com/api/phblogo?text1=${lpornhub}&text2=${lpornhub2}`, 'ph.jpg', 'Nih Mamang\n\nFollow @kenajga.exe', id)
                    .then(() => console.log('Success creating image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await bocchi.reply(from, 'Error!', id)
            ...
            case 'blackpink':
                ...
                await bocchi.sendFileFromUrl(from, `http://docs-jojo.herokuapp.com/api/hubpink?text=${textnyo}`, `${q}.jpg`, 'Neh Blek Peng\n@kenajaga.exe', id)
...
​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​��​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​b`
            ...
            case 'leave':
                ...
                if (!isGroupMsg) return await bocchi.reply(from, ind.groupOnly(), id)
                if (!isGroupAdmins) return await bocchi.reply(from, ind.adminOnly(), id)
                await bocchi.sendText(from, 'Dadah Owner Admin And Senpaaiii Lainnya~~ 👋')
            ...
            case 'admin':
                ...
                const lastAdmin = F.getF(sender.id, _daily)
            ...
            case 'everyone':
                ...
                const lastEveryone = F.getF(sender.id, _daily)
            ...
            case 'bc':
                ...
                for (let bcs of chats) {
                    ...
                    if (!cvk.isReadOnly) await bocchi.sendText(bcs, `_*Broadcast Message*_\n-FrenzYSG\n\n${q}\n\n_*Broadcast Message*_\n-FrenzYSG`)
                }
