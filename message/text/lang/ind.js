...
exports.wait = () => {
    return `Sebentar Senpaii ><\nPermintaan Mu Lagi Aku Proses!\n\nFollow @kenajaga.exe yaaa:>`
}
...
exports.wrongFormat = () => {
    return `Senpaii Cara Penggunaan Fitur Itu Salah!\nBaca Tata Cara Di *${prefix}menu* Dengan Benar!\n\nDi Setiap Fitur Kami Kasih Cara Penggunanya:).`
}
...
exports.cmdNotFound = (cmd) => {
    return `Maaf Sebelumnya Command *${prefix}${cmd}* Sepertinya Tidak Tersedia Di Menu Bot Ini\nAtau Pastikan Anda Tidak Typo :v`
}
...
exports.notRegistered = () => {
    return `Maaf Kamu Belum Registrasi Di BOT Ini\nRegist Dengan Cara *${prefix}daftar*\nContoh : *${prefix}daftar Frenzy | 20*`
}

exports.registered = (name, age, userId, time, serial) => {
    return `*「 REGISTRATION 」*\n\nNomor Mu Di Kenal Oleh Bot Sebagai\n\nNama : *${name}*\nUmur : *${age}*\nID Mu : *${userId}*\nWaktu Pendaftaran : *${time}*\nSerial Number : *${serial}*\n\nTerima Kasih Telah Melakukan Pendaftaran!..\nKetik *${prefix}menu* Untuk Melihat Fitur BOT Ini\n\n~FrenzY X BOT Version : 4.1.2\n\nFollow : *@kenajaga.exe* Agar Tahu info Tentang BOT Ini\n\n\nNomor Serial Mu Tidak Boleh Di Bagikan Kpada Org Lain!\nMaka Dari Itu *#daftar* Hanya Bisa Di Lakukan Di Private Chat!\nSeial Mu : *${serial}*`
}

exports.registeredAlready = (name, age, time) => {
    return `Maaf Kamu Sudah Terdaftar Di Bot Ini!\nKamu Tidak Bisa Mendaftar 2x\n\nAkun Mu Bernama : *${name}*\nDengan Umur : *${age}\nWaktu Pendaftaran : *${time}*\n\nSelalu Ingat Dengan FrenzY X BOT :`
}
...
exports.linkDetected = () => {
    return `*「 ANTI GROUP LINK 」*\n\nMaaf Kamu Telah Mengirim Link Grup!\nKamu Harus Tertendang Dari Grup Ini :(\nIni Permintaan Admin Sampai Jumpaaaa\nByee~~~~`
}
...
exports.pcOnly = () => {
    return `Maaf Kamu Bisa Menjalankan Menu Ini Hanya Di Private Chat! Di Karena Kan Ada Feature *Privacy :)*`
}
...
Setiap User Kami Kasih *9999999999* Limit!
Limit Adalah Semacam Stamina Yg Kamu Punyai
Untuk Menjalankan Bot Ini! Jika Limit Mu 0 
Bot Tidak Akan Menjalankan Perintah Mu!
Cek Limit Mu Sekarang Dengan Cara *#limit*
...
「 Pilih *#menu (angka)* Untuk Membuka Suatu Menu!
Contoh : *#menu 1* Membuka Downloader! 」

*╔══✪*〘  TIPS GUNAKAN BOT  〙✪════
*╠*
*╠* Gunakan *#reminder*
*╠* agar bot bisa mengingatkan mu 
*╠* atau chat mu dengan tepat waktu!
*╠* Contoh : #reminder 10sec | saya harus sekolah
*╠* Gunakan Dengan Bijak ;)
*╠*
*╠* Gunakan *#level*
*╠* Untuk Melihat Profile Anda Dan Exp
*╠* *#level* Berfungsi Untuk Menampilkan Exp Anda!
*╠*
*╠* Gunakan *#me*
*╠* untuk Melihat Profile Anda Di Bot Ini !!
*╠* Bot Akan Menampilkan Level Anda Dan Exp Anda!
*╠*
*╚═✪*〘* FrenzY X BOT* 〙*✪════*
...
*╠*
*╠* Gunakan *#leveling on*
*╠* Agar Bisa MengAkses Game Leveling:)
*╠*
*╠* Gunakan *#nsfw enable*
*╠* Untuk Mengizinkan BOT Mengirim Feature 18+
*╠*
*╠* Gunakan *#antilink on*
*╠* Agar Bot Keluarkan/kick Seseorang Yang\nMengirim Link Grup Lain!
*╠*   
*╠* Gunakan *#welcome on*
*╠* Agar Bot Bisa Menyapa Member Baru!
*╠*   
*╠*
*╚═✪*〘* FrenzY X BOT* 〙*✪════*
...
Terima Kasih Sudah Menggunakan FrenzY X BOT !!
_Index of [1]_
    `
}
...
8. *${prefix}nimesticker*
bot akan mnegirim sticker anime.
Aliases: -
